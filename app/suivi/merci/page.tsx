  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-canvas px-4 py-12">
      <div className="w-full max-w-md rounded-xl border border-border bg-surface p-8 text-center shadow-sm">
        ...
        <h1 className="mt-1 text-xl font-semibold text-content">Suivi bien reçu</h1>
        <p className="mt-3 text-sm text-content-muted">
          Merci d&apos;avoir pris le temps de répondre. Vos retours aident votre
          kinésithérapeute à ajuster votre suivi. Vous pouvez fermer cette page.
        </p>
      </div>
    </main>
  );
