        ...
        >
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-t-2xl bg-surface shadow-2xl sm:rounded-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 px-6 py-5">
              ...
              <label className="flex flex-col gap-1">
                <span className="text-sm font-medium text-content">Description <span className="text-danger-500">*</span></span>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-sm font-medium text-content">Fréquence</span>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <label className="flex flex-col gap-1">
                  <span className="text-sm font-medium text-content">Durée</span>
                  <input name="duration" defaultValue={exercise?.duration ?? ""} placeholder="3 séries de 10"
                    className="rounded-md border border-border-strong px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
                </label>
                <label className="flex flex-col gap-1">
                  <span className="text-sm font-medium text-content">Lien média</span>
